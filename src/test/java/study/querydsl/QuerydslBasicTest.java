...
//        List<Member> content = results.getResults();
     ...
     * 1. 회원 나이 내림차순(desc)
     * 2. 회원 이름 올림차순(asc)
     * 단 2에서 회원 이름이 없으면 마이막에 출력(nulls last)
     */
    @Test
    public void sort() {
    ...
    /*
     ** Projections.been
     *  - getter, setter를 이용해서 dto로 전환시켜줌
     */
    @Test
    ...
    /**
     *  Projections.fields
     *  - getter, setter 없이 dto에 필드에 그대로 값을 넣는 방식
     */
    @Test
    ...
    /**
     * 1. entity와 fields명이 다를 때
     * 2. select절에 subquery를 사용했을 때
     */
    @Test
    ...
    public void dynamicQuery_booleanBuilder() {
        ...
        List<Member> result = this.searchMember1(usernameParam, ageParam);
    ...
    public void dynamicQuery_whereParam() {
        ...
        List<Member> result = this.searchMember2(usernameParam, ageParam);
        assertThat(result.size()).isEqualTo(1);
    }
